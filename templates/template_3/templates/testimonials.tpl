    ...
    <td width="650" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" align="center" cellpadding="10" cellspacing="0">
      ...
      <tr>
        <td height="302" valign="top" bgcolor="#FFFFFF"><table width="609" border="0" align="center" cellpadding="15" cellspacing="12">
            <tr>
              <td valign="top" bgcolor="#FFFFFF"><div align="left"><font color="#3399CC" size="2" face="Arial, Helvetica, sans-serif"><strong>{$testimonail_1}</strong></font></div></td>
            </tr>
            <tr>
            ...
            <tr>
              <td valign="top" bgcolor="#FFFFFF"><div align="left"><font size="2" face="Arial, Helvetica, sans-serif"><font color="#3399CC"><strong>{$testimonail_3}</strong></font></font></div></td>
            </tr>
            <tr>
            ...
            <tr>
              <td valign="top" bgcolor="#FFFFFF"><div align="left"><font size="2" face="Arial, Helvetica, sans-serif"><font color="#3399CC"><strong>{$testimonail_5}</strong></font></font></div></td>
            </tr>
            <tr>
