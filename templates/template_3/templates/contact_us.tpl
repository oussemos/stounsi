  ...
  <tr>
    <td width="179" valign="top" bgcolor="#336699"><br>
      <table width="82%" border="0" align="center" cellpadding="11" cellspacing="0">
        <tr>
          <td valign="top"><div align="left"><font face="Arial, Helvetica, sans-serif"><font color="#FFFFFF" size="3" face="Arial, Helvetica, sans-serif"><font color="#FFFFFF" size="3">{section name=outer loop=$Menu} <a href="{$Menu[outer][1]}" title="{$Menu[outer][0]}">{$Menu[outer][0]}</a><br>
                  <br>
            {sectionelse}
            none
