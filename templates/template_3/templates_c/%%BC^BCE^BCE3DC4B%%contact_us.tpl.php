<?php /* Smarty version 2.6.19, created on 2011-10-15 19:41:06
  ...
  <tr>
    <td width="179" valign="top" bgcolor="#336699"><br>
      <table width="82%" border="0" align="center" cellpadding="11" cellspacing="0">
        <tr>
          <td valign="top"><div align="left"><font face="Arial, Helvetica, sans-serif"><font color="#FFFFFF" size="3" face="Arial, Helvetica, sans-serif"><font color="#FFFFFF" size="3"><?php unset($this->_sections['outer']);
      ...
      <tr>
        ...
        <td width="628" valign="top"><div align="center"><br>
          <table width="542" border="0" cellspacing="0" cellpadding="20">
			...
			<div align="left"><b><font color="#333333" size="4" face="Century Gothic"> <font color="#336699" size="5" face="Arial, Helvetica, sans-serif">Contact Us </font></font></b></div>
			<font color="#333333" size="2" face="trebuchet MS"><br />
			<font face="Arial, Helvetica, sans-serif">			<?php if (! empty ( $this->_tpl_vars['contact_us_text'] )): ?>			</font></font>
			...
			<div class="article_wrapper" id="contact_form"> <font color="#009933" size="3" face="Arial, Helvetica, sans-serif"><strong>Please fill out the short form below and we will respond to you promptly.</strong></font><font color="#009933" size="3" face="trebuchet MS"><strong></strong></font> <br>
			<form>
			  <table align="center">
			    <tr>
...
"><img src="images/linkedin.png" alt="LinkedIn" border="0" /></a><?php endif; ?></p>
  ...
  <tr>
    <td height="34" colspan="3" bgcolor="#3399CC">&nbsp;&nbsp;<font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">&copy;
