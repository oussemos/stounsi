<?php /* Smarty version 2.6.19, created on 2011-10-15 15:12:42
...
" width="220" border="0"></font></a></font></strong></p>
  ...
  <tr>
    ...
    <td colspan="2" valign="middle" bgcolor="#000000"><div align="right"><font color="#FFFFFF" size="4" face="Arial, Helvetica, sans-serif">CALL US TODAY!<strong> &nbsp;</strong><?php echo $this->_tpl_vars['about_us_phone']; ?>
</font><font color="#FFFFFF" face="Arial, Helvetica, sans-serif"><strong>&nbsp;&nbsp;&nbsp;&nbsp;</strong></font></div></td>
  </tr>
  
  
  <tr>
    <td width="179" height="358" valign="top" bgcolor="#FFFFFF"><table width="147" height="19" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
...
"><img src="images/linkedin.png" alt="LinkedIn" border="0" /></a><?php endif; ?></p>
    ...
    <td width="650" valign="top" bgcolor="#FFFFFF"><div align="center">
      <table width="650" height="100%" border="0" cellpadding="15" cellspacing="15">
        ...
        <tr>
          <td width="545" height="328" colspan="2" valign="top" bgcolor="#EFEFEF"><div align="left"><font color="#666666" size="2" face="trebuchet MS">            <font color="#4A3093" size="5" face="Arial, Helvetica, sans-serif"><?php echo $this->_tpl_vars['company_name']; ?>
</font><br>
            <br>
                  <font face="Arial, Helvetica, sans-serif"><?php echo $this->_tpl_vars['about_us_text']; ?>
</font></font></div></td>
          </tr>
      </table>
    </div></td>
    <td width="175" valign="top" bgcolor="#000000"><table width="143" border="0" align="center" cellpadding="13" cellspacing="0">
      <tr>
...
"><?php echo $this->_tpl_vars['Menu'][$this->_sections['outer']['index']][0]; ?>
  ...
  <tr>
    <td height="32" colspan="3" valign="middle" bgcolor="#000000"><span class="style3"><span class="style4">&nbsp;&nbsp;<font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">&copy;  
