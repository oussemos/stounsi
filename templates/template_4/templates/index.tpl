...
<table width="1004" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td colspan="2" valign="middle" bgcolor="#000000"><div align="right"><font color="#FFFFFF" size="4" face="Arial, Helvetica, sans-serif">CALL US TODAY!<strong> &nbsp;</strong>{$about_us_phone}</font><font color="#FFFFFF" face="Arial, Helvetica, sans-serif"><strong>&nbsp;&nbsp;&nbsp;&nbsp;</strong></font></div></td>
  </tr>
  ...
  <tr>
    ...
    <td width="650" valign="top" bgcolor="#FFFFFF"><div align="center">
      <table width="650" height="100%" border="0" cellpadding="15" cellspacing="15">
        ...
        <tr>
          <td width="545" height="328" colspan="2" valign="top" bgcolor="#EFEFEF"><div align="left"><font color="#666666" size="2" face="trebuchet MS">            <font color="#4A3093" size="5" face="Arial, Helvetica, sans-serif">{$company_name}</font><br>
            <br>
                  <font face="Arial, Helvetica, sans-serif">{$home_text}</font></font></div></td>
          </tr>
      </table>
    </div></td>
