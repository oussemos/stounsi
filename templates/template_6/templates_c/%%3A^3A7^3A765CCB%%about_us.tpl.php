<?php /* Smarty version 2.6.19, created on 2011-10-16 01:54:39
         compiled from about_us.tpl */ ?>
<title><?php echo $this->_tpl_vars['company_name']; ?>
 | About Us</title><body bgcolor="#333333" background="images/backgd3.jpg" link="#FF6600" vlink="#FF6600" alink="#FF6600" topmargin="20"><br>
    ...
    <td width="650" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" align="center" cellpadding="10" cellspacing="0">
      ...
      <tr>
        <td valign="top"><table width="610" border="0" align="center" cellpadding="15" cellspacing="0">
            <tr>
              <td width="580" valign="top" bgcolor="#F5F5F5"><div align="left"><font color="#666666" size="2" face="trebuchet MS"><?php echo $this->_tpl_vars['about_us_text']; ?>
</font></div></td>
            </tr>
          </table>
          <p align="left">&nbsp;</p></td>
