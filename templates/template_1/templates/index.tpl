...
<table width="1004" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <div align="right"><font color="#FFFFFF" face="Century Gothic">CALL US TODAY!</font><font color="#FFFFFF" face="Arial, Helvetica, sans-serif"><strong> &nbsp;</strong><font face="Century Gothic">{$about_us_phone}</font><strong>&nbsp;&nbsp;&nbsp;&nbsp;</strong></font></div></td>
  </tr>
  ...
  <tr>
    ...
    <td width="650" valign="top" bgcolor="#FFFFFF"><div align="center">
      ...
      <table width="650" border="0" cellspacing="15" cellpadding="15">
        ...
        <tr>
          <td width="386" height="215" valign="top" bgcolor="#EFEFEF"><div align="left"><font color="#666666" size="2" face="Century Gothic">            {$home_text}</font></div></td>
          <td width="159" valign="top" bgcolor="#EFEFEF"><div align="left">
            <p><font color="#666666" size="2" face="Century Gothic">{$about_us_address}<br>
              {$about_us_city} &nbsp;{$about_us_state}&nbsp; {$about_us_zip}<br>
                    <strong>Hours: </strong>{$about_us_hours}</font><br>
                    <font color="#666666" size="2" face="Century Gothic"><strong>Call Us:</strong> {$about_us_phone}</font></p>

<p>
{if ($facebook_link)}<a href="{$facebook_link}"><img src="images/facebook.png" alt="Facebook Us!" border="0" /></a>&nbsp;{/if}
{if ($twitter_link)}<a href="{$twitter_link}"><img src="images/twitter.png" alt="Follow Us!" border="0" /></a>&nbsp;{/if}
{if ($linkedin_link)}<a href="{$linkedin_link}"><img src="images/linkedin.png" alt="LinkedIn" border="0" /></a>{/if}
</p>
...
{$company_name}. All rights reserved.</font></span></span> </td>
  ...
  <tr>    <td height="28" colspan="3" valign="middle"><div align="right"><font size="1" face="Arial, Helvetica, sans-serif">created with<strong> yourdomain.com</strong></font><font size="1" face="Arial, Helvetica, sans-serif"><strong></strong></font></div></td>  </tr>{/if}
</table>
