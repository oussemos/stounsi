...
<table width="1004" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="650" valign="top" bgcolor="#FFFFFF"><div align="center">
      <table width="650" border="0" cellspacing="15" cellpadding="15">
        ...
        <tr>
          <td height="92" valign="top" bgcolor="#EFEFEF"><div align="left"><font color="#666666" size="2" face="Century Gothic">            {$home_text}</font></div></td>
          </tr>
      </table>
    </div></td>
  ...
  <tr>
    <td height="32" colspan="3" valign="middle" bgcolor="#E42130"><span class="style3"><span class="style4">&nbsp;&nbsp;<font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">&copy;  
