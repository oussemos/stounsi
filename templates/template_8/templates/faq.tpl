...
<table width="1004" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td width="543" valign="top" bgcolor="#F5F5F5"><div align="left">
				...
				<div class="article_wrapper">					
				  <p><font color="#009933" size="2" face="Arial, Helvetica, sans-serif"><strong><font color="#7D3602" face="Century Gothic">Q. {$FAQ[outer][0]}</font></strong></font></p>
  ...
  <tr>
    <td height="36" colspan="3" bgcolor="#7D3602">&nbsp;&nbsp;<font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">&copy;
