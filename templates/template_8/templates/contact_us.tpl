...
<table width="1004" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td width="628" valign="top"><div align="center"><br>
          <table width="542" border="0" cellspacing="0" cellpadding="20">
			...
			<div align="left"> <font color="#333333" size="4" face="Century Gothic"><font color="#C85802">Contact Us</font></font> </div>
			...
			<div class="article_wrapper" id="contact_form"> <font color="#7D3602" size="3" face="Century Gothic"><strong>Please fill out the short form below and we will respond to you promptly.</strong></font> <br>
			<form>
			  <table align="center">
			    <tr>
  ...
  <tr>
    <td height="34" colspan="3" bgcolor="#7D3602">&nbsp;&nbsp;<font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">&copy;
